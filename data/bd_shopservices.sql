CREATE DATABASE  IF NOT EXISTS `shopservice` /*!40100 DEFAULT CHARACTER SET utf8 COLLATE utf8_bin */;
USE `shopservice`;
...
--
-- Table structure for table `animatedimages`
--

DROP TABLE IF EXISTS `animatedimages`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `animatedimages` (
...
LOCK TABLES `animatedimages` WRITE;
/*!40000 ALTER TABLE `animatedimages` DISABLE KEYS */;
INSERT INTO `animatedimages` VALUES (1,'Адская кухня',1700),(2,'Адская кухня',1700);
...
LOCK TABLES `mainservice` WRITE;
/*!40000 ALTER TABLE `mainservice` DISABLE KEYS */;
INSERT INTO `mainservice` VALUES (1,2500,'2'),(2,3000,'3'),(3,3500,'4');
...
INSERT INTO `service` VALUES (2,'Арка из шаров','1500',0),(3,'Сладкая вата','100',1),(4,'Арка из шаров','1500',0),(5,'Сладкая вата','100',0),(6,'Арка из шаров','1500',0),(7,'Сладкая вата','100',0);
/*!40000 ALTER TABLE `service` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `structureorders`
--

DROP TABLE IF EXISTS `structureorders`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `structureorders` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
LOCK TABLES `structureorders` WRITE;
/*!40000 ALTER TABLE `structureorders` DISABLE KEYS */;
INSERT INTO `structureorders` VALUES (4,9,3,800),(5,9,2,1500),(8,10,2,1500),(9,10,3,500);
...
-- Dump completed on 2024-01-10 13:54:31
